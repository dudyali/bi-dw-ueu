...
@section('content')
    <div class="row">
        <div class="col-md-6">
            <h3>Realisasi Penerimaan PAD Tahun 2020</h3>
    ...
    <div class="row mb-3 mt-3">
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h3><sup>Rp</sup> {{ number_format($jenis->pokok, 0) }}</h3>
                    <small>Total Pokok Pajak {{ ucwords(strtolower($jenis->nama)) }}</small>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h3><sup>Rp</sup> {{ number_format($jenis->denda, 0) }}</h3>
                    <small>Total Denda Pajak {{ ucwords(strtolower($jenis->nama)) }}</small>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h3><sup>Rp</sup> {{ number_format($jenis->total, 0) }}</h3>
                    <small>Jumlah Pajak {{ ucwords(strtolower($jenis->nama)) }}</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row" style="margin-top: 30px">
        <div class="col-md-12">
            <h6 class="float-left">Tabel Penerimaan Pajak {{ ucwords(strtolower($jenis->nama)) }} Berdasarkan Kategori Pajak Dikelompokan Per Bulan (Termasuk Piutang)</h6>
