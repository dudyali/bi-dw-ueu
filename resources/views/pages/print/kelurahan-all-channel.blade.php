...
<body onload="window.print()" onfocus="window.close()">
    ...
    Seluruh detail penerimaan PBB dari seluruh channel pembayaran pada kecamatan {{ ucwords(strtolower($kecamatan->name)) }} kelurahan {{ ucwords(strtolower($kelurahan->name)) }}.
    <br><br>
