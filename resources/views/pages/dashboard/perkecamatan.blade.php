...
@section('content')
                ...
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        @foreach ($all_year as $item)
                            <a class="dropdown-item" href="{{ route('dashboard.perkecamatan', $item->year) }}">{{ $item->year }}</a>
                        @endforeach
                    </div>
                </div>
            </div>
    ...
    <div class="row mb-3 mt-2">
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h3><sup>Rp</sup> {{ number_format($realisasi_tahun_berjalan[0]->total, 0) }}</h3>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h3><sup>Rp</sup> {{ number_format($realisasi_piutang[0]->total, 0) }}</h3>
    ...
    <div class="row" id="section-to-print">
        <div class="col-md-12 mt-3 table-responsive">
            Realisasi & Piutang Per Kecamatan Tahun {{ $tahun }}
            <hr class="mb-4">
            <table class="table table-bordered">
                ...
                <tbody>
                    @foreach ($data_per_kecamatan as $key => $item)
                        <tr>
                            <td>{{ $key = $key + 1 }}</td>
                            <td><a href="{{ route('dashboard.perkelurahan', [$item['id_kecamatan'], $tahun]) }}">{{ $item['kecamatan'] }}</a></td>
