...
@section('content')
    <div class="row">
        <div class="col-md-6">
            <h3>Piutang Pajak {{ ucwords(strtolower($kp->jenis->nama)) }} {{ $kp->tahun }} - Kategori {{ ucwords(strtolower($kp->nama)) }}</h3>
    ...
    <div class="row" style="margin-top: 30px">
        <div class="col-md-12">
            <h6>Tabel Realisasi Piutang Pajak Berdasarkan Kategori Pajak {{ ucwords(strtolower($kp->nama)) }}</h6> <hr>
